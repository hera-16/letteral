...
INSERT IGNORE INTO tenants (id, name, slug, plan_type, status, max_users, max_storage_gb, contact_email, created_at)
VALUES (
  999,
...
INSERT IGNORE INTO organizations (id, tenant_id, parent_id, name, organization_type, level, path, created_at)
VALUES (
  999,
  999,
  NULL,
...
INSERT IGNORE INTO policy_settings (
  tenant_id,
  organization_id,
